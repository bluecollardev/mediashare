...
import { CreateMediaItemDto, MediaItem, UpdateMediaItemDto } from '../models';
...
export class MediaItemsApi extends BaseAPI {
  ...
  mediaItemControllerFindOne(
    { id }: MediaItemControllerFindOneRequest,
    opts?: OperationOpts
  ): Observable<RawAjaxResponse<MediaItem>>;
  mediaItemControllerFindOne(
    { id }: MediaItemControllerFindOneRequest,
  ...
  mediaItemControllerShare(
    { id, userId }: MediaItemControllerShareRequest,
    opts?: OperationOpts
  ): Observable<RawAjaxResponse<MediaItem>>;
  mediaItemControllerShare(
    { id, userId }: MediaItemControllerShareRequest,
    ...
    return this.request<MediaItem>(
      {
        url: '/api/media-items/{id}/share/{userId}'
  ...
  mediaItemControllerUpdate(
    { id, updateMediaItemDto }: MediaItemControllerUpdateRequest,
    opts?: OperationOpts
  ): Observable<RawAjaxResponse<MediaItem>>;
  mediaItemControllerUpdate(
    { id, updateMediaItemDto }: MediaItemControllerUpdateRequest,
