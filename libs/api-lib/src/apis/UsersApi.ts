...
import { CreateUserDto, LoginDto, MediaItemDto, Playlist, ShareItem, UpdateUserDto, UserDto } from '../models';
...
export class UsersApi extends BaseAPI {
  ...
  usersControllerCreate(
    { createUserDto }: UsersControllerCreateRequest,
    opts?: OperationOpts
  ...
  usersControllerFindOne(
    { id }: UsersControllerFindOneRequest,
    opts?: OperationOpts
  ): Observable<RawAjaxResponse<UserDto>>;
  usersControllerFindOne(
    { id }: UsersControllerFindOneRequest,
  ...
  usersControllerGetMedia(
    { id }: UsersControllerGetMediaRequest,
    opts?: OperationOpts
  ...
  usersControllerGetPlaylists(
    { id }: UsersControllerGetPlaylistsRequest,
    opts?: OperationOpts
  ...
  /**
   */
  usersControllerGetSharedMediaItems({
    id,
  }: UsersControllerGetSharedMediaItemsRequest): Observable<Array<MediaItemDto>>;
  usersControllerGetSharedMediaItems(
    { id }: UsersControllerGetSharedMediaItemsRequest,
    opts?: OperationOpts
  ): Observable<RawAjaxResponse<Array<MediaItemDto>>>;
  usersControllerGetSharedMediaItems(
    { id }: UsersControllerGetSharedMediaItemsRequest,
  ...
  usersControllerGetSharedPlaylists(
    { id }: UsersControllerGetSharedPlaylistsRequest,
    opts?: OperationOpts
  ): Observable<RawAjaxResponse<Array<Playlist>>>;
  usersControllerGetSharedPlaylists(
    { id }: UsersControllerGetSharedPlaylistsRequest,
  ...
  usersControllerLogin(
    { loginDto }: UsersControllerLoginRequest,
    opts?: OperationOpts
  ...
  usersControllerReadSharedItem(
    { id, shareId }: UsersControllerReadSharedItemRequest,
    opts?: OperationOpts
  ): Observable<RawAjaxResponse<UserDto>>;
  usersControllerReadSharedItem(
    { id, shareId }: UsersControllerReadSharedItemRequest,
    ...
    return this.request<UserDto>(
      {
        url: '/api/users/{id}/shared-items/{shareId}'
          .replace('{id}', encodeURI(id))
          .replace('{shareId}', encodeURI(shareId)),
        method: 'POST',
      },
      opts?.responseOpts
    );
  ...
  usersControllerRemove(
    { id }: UsersControllerRemoveRequest,
    opts?: OperationOpts
  ): Observable<void | RawAjaxResponse<void>>;
  usersControllerRemove(
    { id }: UsersControllerRemoveRequest,
  ...
  usersControllerSetRoles(
    { id, requestBody }: UsersControllerSetRolesRequest,
    opts?: OperationOpts
  ): Observable<RawAjaxResponse<UserDto>>;
  usersControllerSetRoles(
    { id, requestBody }: UsersControllerSetRolesRequest,
  ...
  usersControllerUpdate(
    { id, updateUserDto }: UsersControllerUpdateRequest,
    opts?: OperationOpts
  ): Observable<RawAjaxResponse<UserDto>>;
  usersControllerUpdate(
    { id, updateUserDto }: UsersControllerUpdateRequest,
