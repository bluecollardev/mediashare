...
export const playlistToPlaylistDtoMappingFactory = (mapper) => createMap(
  mapper,
  Playlist,
  PlaylistDto,
  forMember((dest: PlaylistDto) => dest._id, convertUsing(objectIdToStringConverter as never, (source: Playlist) => source._id)),
...
export const createPlaylistDtoToPlaylistMappingFactory = (mapper) => createMap(
  mapper,
  CreatePlaylistDto,
  Playlist,
...
export const updatePlaylistDtoToPlaylistMappingFactory = (mapper) => createMap(
  mapper,
  UpdatePlaylistDto,
  Playlist,
