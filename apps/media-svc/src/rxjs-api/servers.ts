...
const server2 = new ServerConfiguration<{}>(
  'https://mediashare-api-staging.herokuapp.com',
  {},
  'staging'
);
const server3 = new ServerConfiguration<{}>(
  'https://mediashare-api-prod.herokuapp.com',
  {},
  'production'
);
