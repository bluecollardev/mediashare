...
export const updateUserDtoToUserMappingFactory = (mapper) =>
  createMap(
    mapper,
    UpdateUserDto,
    User,
    forMember(
      ...
      convertUsing(
        ...
        (source: UpdateUserDto) => source._id
      )
    )
