...
export class ViewsController {
  ...
  @ViewsPostResponse()
  createPlaylistView(@Param('playlistId', new ObjectIdPipe()) playlistId: ObjectId, @GetUser('_id') createdBy: ObjectId) {
  ...
  @ViewsPostResponse()
  createMediaView(@Param('mediaId', new ObjectIdPipe()) mediaId: ObjectId, @GetUser('_id') createdBy: ObjectId) {
