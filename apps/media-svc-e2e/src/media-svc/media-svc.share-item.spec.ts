...
describe('ShareItemAPI.e2e', () => {
  ...
  describe('ShareItemApi validation', () => {
  ...
  describe('ShareItemApi should create a first shared item', () => {
    it('should create a first shared item', async () => {
      const uc1dto = {
        userId: user._id,
        connectionId: conn1._id,
      } as CreateUserConnectionDto;

      // Create shared item 1
      await axios
        .post(
          `${baseUrl}/user/connections/create`,
          uc1dto,
  ...
  describe('ShareItemApi should create a second shared item', () => {
    it('should create a second shared item', async () => {
      // Create shared item 2
      const uc2dto = {
        userId: user._id,
  ...
  describe('ShareItemApi should get the two shared items we created', () => {
    it('should get the two shared items we created', async () => {
      await axios
        .get(
    ...
    /* it('should delete the shared item we created', async () => {
