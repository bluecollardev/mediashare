...
export class ShareItemsApi extends BaseAPI {
    ...
    shareItemControllerRemoveShareItemAll({ shareItemsDto }: ShareItemControllerRemoveShareItemAllRequest, opts?: OperationOpts): Observable<void | RawAjaxResponse<void>>
    shareItemControllerRemoveShareItemAll({ shareItemsDto }: ShareItemControllerRemoveShareItemAllRequest, opts?: OperationOpts): Observable<void | RawAjaxResponse<void>> {
