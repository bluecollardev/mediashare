...
export class UsersApi extends BaseAPI {
    ...
    usersControllerGetPlaylists({ userId }: UsersControllerGetPlaylistsRequest, opts?: OperationOpts): Observable<Array<PlaylistResponseDto> | RawAjaxResponse<Array<PlaylistResponseDto>>> {
