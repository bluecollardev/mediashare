...
// import TextInputIcon, { Props as TextInputIconProps } from 'react-native-paper/src/components/TextInput/Adornment/TextInputIcon';
// import TextInputAffix, { Props as TextInputAffixProps } from 'react-native-paper/src/components/TextInput/Adornment/TextInputAffix';
import TextInputIcon from 'react-native-paper/src/components/TextInput/Adornment/TextInputIcon';
import TextInputAffix from 'react-native-paper/src/components/TextInput/Adornment/TextInputAffix';
import { withTheme } from 'react-native-paper/src/core/theming';
import type { RenderProps, TextInputLabelProp } from 'react-native-paper/src/components/TextInput/types';
...
interface CompoundedComponent extends React.ForwardRefExoticComponent<TextInputProps & React.RefAttributes<TextInputHandles>> {
  ...
  Affix: React.FunctionComponent<Partial<any>>;
}
...
const TextInput = React.forwardRef<TextInputHandles, TextInputProps>(
  (
    ...
    const { current: labeled } = React.useRef<Animated.Value>(new Animated.Value(validInputValue ? 0 : 1));
    const { current: error } = React.useRef<Animated.Value>(new Animated.Value(errorProp ? 1 : 0));
