...
import { View, TextInput as NativeTextInput, StyleSheet, I18nManager, Platform, TextStyle, ColorValue } from 'react-native';
import color from 'color';
import TextInputAdornment, {
  getAdornmentConfig,
  getAdornmentStyleAdjustmentForNativeInput,
  TextInputAdornmentProps,
} from 'react-native-paper/src/components/TextInput/Adornment/TextInputAdornment';

import InputLabel from 'react-native-paper/src/components/TextInput/Label/InputLabel';
import LabelBackground from 'react-native-paper/src/components/TextInput/Label/LabelBackground';
...
import { AdornmentType, AdornmentSide } from 'react-native-paper/src/components/TextInput/Adornment/enums';
...
const TextInputOutlined = ({
  ...
  const baseLabelTranslateX =
    (I18nManager.isRTL ? 1 : -1) * (labelHalfWidth - (labelScale * labelWidth) / 2 - (fontSize - MINIMIZED_LABEL_FONT_SIZE) * labelScale);
...
const Outline = ({ theme, hasActiveOutline, activeColor, outlineColor, focused, backgroundColor }: OutlineProps) => (
  <View
