...
/**
 */
function mediaItemControllerFindAllRaw<T>(
  requestConfig: runtime.TypedQueryConfig<T, Array<MediaItem>> = {}
): QueryConfig<T> {
  let queryParameters = null;
...
/**
 */
export function mediaItemControllerFindAll<T>(
  requestConfig?: runtime.TypedQueryConfig<T, Array<MediaItem>>
): QueryConfig<T> {
...
function mediaItemControllerFindOneRaw<T>(
  ...
  if (requestParameters.mediaId === null || requestParameters.mediaId === undefined) {
    throw new runtime.RequiredError(
      'mediaId',
      'Required parameter requestParameters.mediaId was null or undefined when calling mediaItemControllerFindOne.'
    );
  }
  ...
  meta.authType = ['bearer'];
  const config: QueryConfig<T> = {
    url: `${runtime.Configuration.basePath}/api/media-items/{mediaId}`.replace(
      `{${'mediaId'}}`,
...
function mediaItemControllerRemoveRaw<T>(
  ...
  if (requestParameters.mediaId === null || requestParameters.mediaId === undefined) {
    throw new runtime.RequiredError(
      'mediaId',
      'Required parameter requestParameters.mediaId was null or undefined when calling mediaItemControllerRemove.'
    );
  }
...
function mediaItemControllerShareRaw<T>(
  ...
  if (requestParameters.mediaId === null || requestParameters.mediaId === undefined) {
    throw new runtime.RequiredError(
      'mediaId',
      'Required parameter requestParameters.mediaId was null or undefined when calling mediaItemControllerShare.'
    );
  }
  ...
  if (requestParameters.userId === null || requestParameters.userId === undefined) {
    throw new runtime.RequiredError(
      'userId',
      'Required parameter requestParameters.userId was null or undefined when calling mediaItemControllerShare.'
    );
  }
...
function mediaItemControllerUpdateRaw<T>(
  ...
  if (requestParameters.mediaId === null || requestParameters.mediaId === undefined) {
    throw new runtime.RequiredError(
      'mediaId',
      'Required parameter requestParameters.mediaId was null or undefined when calling mediaItemControllerUpdate.'
    );
  }
