...
function usersControllerFindOneRaw<T>(
  ...
  if (requestParameters.userId === null || requestParameters.userId === undefined) {
    throw new runtime.RequiredError(
      'userId',
      'Required parameter requestParameters.userId was null or undefined when calling usersControllerFindOne.'
    );
  }
  ...
  meta.authType = ['bearer'];
  const config: QueryConfig<T> = {
    url: `${runtime.Configuration.basePath}/api/users/{userId}`.replace(
      `{${'userId'}}`,
...
function usersControllerGetPlaylistsRaw<T>(
  ...
  if (requestParameters.userId === null || requestParameters.userId === undefined) {
    throw new runtime.RequiredError(
      'userId',
      'Required parameter requestParameters.userId was null or undefined when calling usersControllerGetPlaylists.'
    );
  }
  ...
  meta.authType = ['bearer'];
  const config: QueryConfig<T> = {
    url: `${runtime.Configuration.basePath}/api/users/{userId}/playlists`.replace(
      `{${'userId'}}`,
      encodeURIComponent(String(requestParameters.userId))
    ),
    meta,
  ...
  if (requestTransform) {
    config.transform = (body: ResponseBody, text: ResponseBody) =>
      requestTransform(body.map(PlaylistResponseDtoFromJSON), text);
  }
...
function usersControllerReadSharedItemRaw<T>(
  ...
  const config: QueryConfig<T> = {
    url: `${runtime.Configuration.basePath}/api/users/shared-items/{shareId}`.replace(
      `{${'shareId'}}`,
...
/**
 */
function usersControllerRemoveRaw<T>(
  ...
  if (requestParameters.userId === null || requestParameters.userId === undefined) {
    throw new runtime.RequiredError(
      'userId',
      'Required parameter requestParameters.userId was null or undefined when calling usersControllerRemove.'
    );
  }
...
/**
 */
export function usersControllerRemove<T>(
  requestParameters: UsersControllerRemoveRequest,
  requestConfig?: runtime.TypedQueryConfig<T, void>
): QueryConfig<T> {
...
function usersControllerSetRolesRaw<T>(
  ...
  if (requestParameters.userId === null || requestParameters.userId === undefined) {
    throw new runtime.RequiredError(
      'userId',
      'Required parameter requestParameters.userId was null or undefined when calling usersControllerSetRoles.'
    );
  }
  ...
  meta.authType = ['bearer'];
  const config: QueryConfig<T> = {
    url: `${runtime.Configuration.basePath}/api/users/{userId}/roles`.replace(
      `{${'userId'}}`,
      encodeURIComponent(String(requestParameters.userId))
    ),
    meta,
...
function usersControllerUpdateRaw<T>(
  ...
  if (requestParameters.userId === null || requestParameters.userId === undefined) {
    throw new runtime.RequiredError(
      'userId',
      'Required parameter requestParameters.userId was null or undefined when calling usersControllerUpdate.'
    );
  }
