...
/**
 */
function shareItemsControllerFindAllRaw<T>(requestConfig: runtime.TypedQueryConfig<T, Array<ShareItem>> = {}): QueryConfig<T> {
...
/**
 */
export function shareItemsControllerFindAll<T>(requestConfig?: runtime.TypedQueryConfig<T, Array<ShareItem>>): QueryConfig<T> {
...
function shareItemsControllerFindOneRaw<T>(
  ...
  if (requestParameters.shareId === null || requestParameters.shareId === undefined) {
    throw new runtime.RequiredError('shareId', 'Required parameter requestParameters.shareId was null or undefined when calling shareItemsControllerFindOne.');
  }
  ...
  meta.authType = ['bearer'];
  const config: QueryConfig<T> = {
    url: `${runtime.Configuration.basePath}/api/share-items/{shareId}`.replace(`{${'shareId'}}`, encodeURIComponent(String(requestParameters.shareId))),
    meta,
    update: requestConfig.update,
    queryKey: requestConfig.queryKey,
    optimisticUpdate: requestConfig.optimisticUpdate,
...
function shareItemsControllerRemoveRaw<T>(
  ...
  if (requestParameters.shareId === null || requestParameters.shareId === undefined) {
    throw new runtime.RequiredError('shareId', 'Required parameter requestParameters.shareId was null or undefined when calling shareItemsControllerRemove.');
  }
