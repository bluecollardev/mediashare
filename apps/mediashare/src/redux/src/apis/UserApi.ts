...
function userControllerAuthorizeRaw<T>(
  ...
  if (requestParameters.id === null || requestParameters.id === undefined) {
    throw new runtime.RequiredError('id', 'Required parameter requestParameters.id was null or undefined when calling userControllerAuthorize.');
  }

  if (requestParameters.tokenDto === null || requestParameters.tokenDto === undefined) {
    throw new runtime.RequiredError('tokenDto', 'Required parameter requestParameters.tokenDto was null or undefined when calling userControllerAuthorize.');
  }
  ...
  const config: QueryConfig<T> = {
    url: `${runtime.Configuration.basePath}/api/user/authorize`.replace(`{${':id'}}`, encodeURIComponent(String(requestParameters.id))),
    meta,
...
/**
 */
function userControllerGetMyShareItemsRaw<T>(requestConfig: runtime.TypedQueryConfig<T, Array<ShareItem>> = {}): QueryConfig<T> {
  let queryParameters = null;
...
/**
 */
export function userControllerGetMyShareItems<T>(requestConfig?: runtime.TypedQueryConfig<T, Array<ShareItem>>): QueryConfig<T> {
...
/**
 */
function userControllerGetSharedMediaItemsRaw<T>(requestConfig: runtime.TypedQueryConfig<T, Array<MediaItemDto>> = {}): QueryConfig<T> {
  let queryParameters = null;
  ...
  const { transform: requestTransform } = requestConfig;
  if (requestTransform) {
    config.transform = (body: ResponseBody, text: ResponseBody) => requestTransform(body.map(MediaItemDtoFromJSON), text);
  }
...
/**
 */
export function userControllerGetSharedMediaItems<T>(requestConfig?: runtime.TypedQueryConfig<T, Array<MediaItemDto>>): QueryConfig<T> {
...
function userControllerLoginRaw<T>(
  ...
  if (requestParameters.loginDto === null || requestParameters.loginDto === undefined) {
    throw new runtime.RequiredError('loginDto', 'Required parameter requestParameters.loginDto was null or undefined when calling userControllerLogin.');
  }
  ...
  const { transform: requestTransform } = requestConfig;
  if (requestTransform) {
    config.transform = (body: ResponseBody, text: ResponseBody) => requestTransform(LoginResponseDtoFromJSON(body), text);
  }
